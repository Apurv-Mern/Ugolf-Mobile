...
JSI_EXPORT extern const char RNMBXPointAnnotationManagerComponentName[];

/*
 * `ShadowNode` for <RNMBXPointAnnotationManager> component.
 */
using RNMBXPointAnnotationManagerShadowNode = ConcreteViewShadowNode<
    RNMBXPointAnnotationManagerComponentName,
    RNMBXPointAnnotationManagerProps,
    RNMBXPointAnnotationManagerEventEmitter,
    RNMBXPointAnnotationManagerState>;
