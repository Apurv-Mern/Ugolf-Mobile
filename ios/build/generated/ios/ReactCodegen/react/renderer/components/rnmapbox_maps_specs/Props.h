...
#pragma mark - Props
  ...
  folly::dynamic stopGesturePropagation{};
...
class RNMBXPointAnnotationManagerProps final : public ViewProps {
 public:
  RNMBXPointAnnotationManagerProps() = default;
  RNMBXPointAnnotationManagerProps(const PropsParserContext& context, const RNMBXPointAnnotationManagerProps &sourceProps, const RawProps &rawProps);

#pragma mark - Props

  folly::dynamic id{};
  folly::dynamic isDefault{};
  folly::dynamic slot{};
  folly::dynamic iconAllowOverlap{};
  folly::dynamic iconIgnorePlacement{};
  folly::dynamic iconOptional{};
  folly::dynamic textAllowOverlap{};
  folly::dynamic textIgnorePlacement{};
  folly::dynamic textOptional{};
