...
RNMBXMapViewProps::RNMBXMapViewProps(
    ...
    scaleBarUnits(convertRawProp(context, rawProps, "scaleBarUnits", sourceProps.scaleBarUnits, {})),
...
folly::dynamic RNMBXMapViewProps::getDiffProps(
  ...
  if (scaleBarUnits != oldProps->scaleBarUnits) {
    result["scaleBarUnits"] = scaleBarUnits;
  }
...
RNMBXMarkerViewProps::RNMBXMarkerViewProps(
    ...
    stopGesturePropagation(convertRawProp(context, rawProps, "stopGesturePropagation", sourceProps.stopGesturePropagation, {})) {}
...
folly::dynamic RNMBXMarkerViewProps::getDiffProps(
  ...
  if (stopGesturePropagation != oldProps->stopGesturePropagation) {
    result["stopGesturePropagation"] = stopGesturePropagation;
  }
  return result;
}
#endif
...
#endif
RNMBXPointAnnotationManagerProps::RNMBXPointAnnotationManagerProps(
    const PropsParserContext &context,
    const RNMBXPointAnnotationManagerProps &sourceProps,
    const RawProps &rawProps): ViewProps(context, sourceProps, rawProps),

    id(convertRawProp(context, rawProps, "id", sourceProps.id, {})),
    isDefault(convertRawProp(context, rawProps, "isDefault", sourceProps.isDefault, {})),
    slot(convertRawProp(context, rawProps, "slot", sourceProps.slot, {})),
    iconAllowOverlap(convertRawProp(context, rawProps, "iconAllowOverlap", sourceProps.iconAllowOverlap, {})),
    iconIgnorePlacement(convertRawProp(context, rawProps, "iconIgnorePlacement", sourceProps.iconIgnorePlacement, {})),
    iconOptional(convertRawProp(context, rawProps, "iconOptional", sourceProps.iconOptional, {})),
    textAllowOverlap(convertRawProp(context, rawProps, "textAllowOverlap", sourceProps.textAllowOverlap, {})),
    textIgnorePlacement(convertRawProp(context, rawProps, "textIgnorePlacement", sourceProps.textIgnorePlacement, {})),
    textOptional(convertRawProp(context, rawProps, "textOptional", sourceProps.textOptional, {})) {}
    
#ifdef RN_SERIALIZABLE_STATE
ComponentName RNMBXPointAnnotationManagerProps::getDiffPropsImplementationTarget() const {
  return "RNMBXPointAnnotationManager";
}

folly::dynamic RNMBXPointAnnotationManagerProps::getDiffProps(
    const Props* prevProps) const {
  static const auto defaultProps = RNMBXPointAnnotationManagerProps();
  const RNMBXPointAnnotationManagerProps* oldProps = prevProps == nullptr
      ? &defaultProps
      : static_cast<const RNMBXPointAnnotationManagerProps*>(prevProps);
  if (this == oldProps) {
    return folly::dynamic::object();
  }
  folly::dynamic result = HostPlatformViewProps::getDiffProps(prevProps);
  ...
  if (isDefault != oldProps->isDefault) {
  ...
  if (iconAllowOverlap != oldProps->iconAllowOverlap) {
    result["iconAllowOverlap"] = iconAllowOverlap;
  }
    
  if (iconIgnorePlacement != oldProps->iconIgnorePlacement) {
    result["iconIgnorePlacement"] = iconIgnorePlacement;
  }
    
  if (iconOptional != oldProps->iconOptional) {
    result["iconOptional"] = iconOptional;
  }
    
  if (textAllowOverlap != oldProps->textAllowOverlap) {
    result["textAllowOverlap"] = textAllowOverlap;
  }
    
  if (textIgnorePlacement != oldProps->textIgnorePlacement) {
    result["textIgnorePlacement"] = textIgnorePlacement;
  }
    
  if (textOptional != oldProps->textOptional) {
