...
export const ENDPOINTS = {
  ...
  TOURNAMENT_LEADERBOARD: (id) => `/api/v1/mobile/tournaments/${id}/leaderboard`,
  ...
  TEAM_MEMBER_CANDIDATES: (id) => `/api/v1/mobile/teams/${id}/member-candidates`,
  TEAM_MEMBERS: (id) => `/api/v1/mobile/teams/${id}/members`,
  TEAM_MEMBER_DELETE: (teamId, playerUserId) => `/api/v1/mobile/teams/${teamId}/members/${playerUserId}`,

  // Tournament Teams APIs
  TOURNAMENT_TEAMS: (id) => `/api/v1/mobile/tournaments/${id}/teams`,
  TOURNAMENT_TEAM_INVITE_CANDIDATES: (id) => `/api/v1/mobile/tournaments/${id}/teams/invite-candidates`,
  TOURNAMENT_TEAM_UNINVITE: (tournamentId, teamId) => `/api/v1/mobile/tournaments/${tournamentId}/teams/${teamId}`,
  TOURNAMENT_TEAM_SELECT: (id) => `/api/v1/mobile/tournaments/${id}/teams/select`,
  TOURNAMENT_TEAM_SEND_INVITE_NOTIFICATIONS: (tournamentId, teamId) => `/api/v1/mobile/tournaments/${tournamentId}/teams/${teamId}/send-invite-notifications`,

  // Team Invites & Notifications APIs
  TEAM_INVITES: (teamId) => `/api/v1/mobile/teams/${teamId}/invites`,
  TEAM_INVITE_ACCEPT: (inviteId) => `/api/v1/mobile/teams/invites/${inviteId}/accept`,
  TEAM_INVITE_REJECT: (inviteId) => `/api/v1/mobile/teams/invites/${inviteId}/reject`,
  ...
  TOURNAMENT_START_GAME_READINESS: (id) => `/api/v1/mobile/tournaments/${id}/start-game/readiness`,
  TOURNAMENT_START_GAME: (id) => `/api/v1/mobile/tournaments/${id}/start-game`,
  GAME_SESSION: (tournamentId, sessionId) => `/api/v1/mobile/tournaments/${tournamentId}/game-sessions/${sessionId}`,
  GAME_SESSION_ANSWER_YES: (tournamentId, sessionId) => `/api/v1/mobile/tournaments/${tournamentId}/game-sessions/${sessionId}/answer-yes`,
  GAME_SESSION_ANSWER_NO: (tournamentId, sessionId) => `/api/v1/mobile/tournaments/${tournamentId}/game-sessions/${sessionId}/answer-no`,
  GAME_SESSION_CONFIRM_INSTRUCTION: (tournamentId, sessionId) => `/api/v1/mobile/tournaments/${tournamentId}/game-sessions/${sessionId}/confirm-instruction`,
  GAME_SESSION_BACK: (tournamentId, sessionId) => `/api/v1/mobile/tournaments/${tournamentId}/game-sessions/${sessionId}/back`,
};
